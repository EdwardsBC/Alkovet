...
public class JDDetalleVenta extends javax.swing.JDialog {
  ...
  private ClsDetalleVenta detalle;
  private List<ClsProducto> productos;

  public JDDetalleVenta(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
  }
  ...
  @SuppressWarnings("unchecked")
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
      ...
      if (this.validarDatos() == true) {
        this.detalle = new ClsDetalleVenta();
  ...
  public static void main(String args[]) {
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        JDDetalleVenta dialog = new JDDetalleVenta(new javax.swing.JFrame(), true);
  ...
  public ClsDetalleVenta agregar() {
